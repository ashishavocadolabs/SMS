...
import {
  ...
  VideoIcon, LectureIcon, TestIcon, ChartIcon, SettingsIcon,
  FaceIcon, CameraIcon,
    ...
    <div className="layout">
      <Sidebar
        ...
        items={[
          ...
          { label: "Face Verify", to: "/student/face-register", icon: <FaceIcon size={18} /> },
          { label: "CV Attendance", to: "/student/face-attendance", icon: <CameraIcon size={18} /> },
          ...
          { label: "Settings", to: "/student/settings", icon: <SettingsIcon size={18} /> },
        ]}
        onLogout={handleLogout}
      />

      <div className="layout__content">
        <PanelHeader userName={name} userLastName={lastName} portalLabel="Student Portal" />
